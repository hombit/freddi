...
cdef extern from 'arguments.hpp':
    ...
    cdef cppclass DiskStructureArguments:
        DiskStructureArguments(const string&, const string&, double, const string&, double, double, double, double) except +
        DiskStructureArguments(const string&, const string&, double, const string&, double, double, double, double, double) except +
        DiskStructureArguments(const string&, const string&, double, const string&, double, double, double, double, double, double) except +
...
cdef extern from 'arguments.hpp' namespace 'DiskStructureArguments':
    cdef double F0Initializer(const BasicDiskBinaryArguments&, const string, const string, double, double, double, double, bint, bint, double, double) except +
