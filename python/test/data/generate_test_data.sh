...
$FREDDI --prefix=issue66 --Mx=9.4 --period=1.116 --Mopt=2.5 --alpha=0.23 --colourfactor=1.7 --inclination=20.7 --time=35 --tau=1 --distance=9.1 --Mdisk0=2.70002635e+25 --Cirr=1.5e-4 --kerr=0.4 --rout=0.7 --opacity=Kramers --initialcond=powerF --powerorder=1.4 --fulldata